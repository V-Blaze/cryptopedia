...
const ExchangeLists = ({ exchange, showDetails }) => {
  ...
  return (
    <button
      ...
      // rounded-md hover:scale-105 hover:mx-3 hover:bg-blue-800"
      onClick={() => showDetails(exchangeId)}
    >
      <div
        // type="button"
        className="flex flex-col text-white bg-blue-900 rounded-md hover:scale-105 hover:mx-3 hover:bg-blue-800"
        // onClick={() => showDetails(exchangeId)}
      >
        <button
          type="button"
